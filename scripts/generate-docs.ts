...
const CATEGORY_LABELS: Record<string, string> = {
  ...
  'comic-drama': '🎞️ 漫剧关键帧',
  'film-storyboard': '🎥 影视分镜与镜头',
  'game-asset': '🎮 游戏资产与道具',
  'social-content': '📱 社交媒体内容',
  'surface-pattern': '🧵 纹样与材质设计',
  'packaging-design': '📦 包装与包装系统',
  'food-beverage': '🍽️ 餐饮与美食视觉',
  'fashion-editorial': '👗 时尚造型与编辑片',
...
const CATEGORY_LABELS_EN: Record<string, string> = {
  ...
  'film-storyboard': '🎥 Film Storyboards & Shots',
  'game-asset': '🎮 Game Assets & Props',
  'social-content': '📱 Social Media Content',
  'surface-pattern': '🧵 Patterns & Surface Design',
  'packaging-design': '📦 Packaging & Packaging Systems',
  'food-beverage': '🍽️ Food & Beverage Visuals',
  'fashion-editorial': '👗 Fashion Styling & Editorial',
